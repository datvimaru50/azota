...
class SubmitExersice extends StatefulWidget {
  SubmitExersice({this.hashId, this.studentId, this.className, this.stdName, this.deadline});
...
class _SubmitExersiceState extends State<SubmitExersice> {
  ...
  Future uploadSingleImage(String imgPath, int index, OnUploadProgressCallback onUploadProgress) async {
    ...
    final uploadInfor = await UploadController.getPulicUpload(fileName, totalByteLength.toString(), lookupMimeType(imgPath));
        ...
        Container(
          child: Column(
            children: [
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Text('vui lòng kiểm tra thông báo để biết kết quả!')
                    ],
                  ),
              ...
              imgFilePaths.length == 0? Container() :
              Container(
                  child: GridView.count(
                    ...
                    children: <Widget>[
                      ...imgFilePaths.map((dynamic item) => Container(
                          key: UniqueKey(),
              ...
              imgFilePaths.length == 0? Container() :
              ElevatedButton(
                onPressed: submitStatus == SubmitStatus.submitting ? null : handleSubmit,
                child: Text(
                  'NỘP BÀI',
